    ...
    <form action="../ajax/agregar-tour.php"  method="POST">
        <div class="row">
         ...
         <div class="col-12">
            ...
            <input required name="Nombre" id="create-noches"class="form-control" type="text" placeholder="Nombre del Tour">
        </p>
        <p>
            <label>Fecha de Inicio</label><br>
            <input required name="fecha" id="create-noches"class="form-control" type="date" placeholder="Nombre del Tour">
        </p>
        <p>
            <label>Cupos</label><br>
            <input required onkeypress='return validaNumericos(event)' name="cupos" id="create-noches"class="form-control" type="text" placeholder="#Número de Cupos">
        </p>
        <p>
