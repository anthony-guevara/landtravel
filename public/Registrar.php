        ...
        <div class="col-12" style="align-content: left;">
                <section id ="div-login">
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-12">
                                        <input onkeypress='return validaNumericos(event)' id="registro-identidad" type="text" placeholder="Identidad"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                        <input id="registro-direccion" type="text" placeholder="Direccion"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                        <input style="height: 73px;" id="pasaporte" type="text" placeholder="Pasaporte"><br>
                                </div>
 
                                            <div class="col-6">
                                                    <label>Fecha de Expiracion</label><br>
                                                    <input id="registro-exp" style="background-color: rgba(0, 0, 0, 0.103);" type="date" class="form-control" placeholder="Fecha-exp"><br>
                                            </div>
			...
			?>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                <div class="col-12">
                                <select class="form-control" id="registro-tipo">
                                ...
                                <div class="row">
                                <div class="col-12">
                                <select class="form-control" id="registro-genero">
