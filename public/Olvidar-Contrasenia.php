...
<!--Primer Cuadro---------------------------------------------------------------------------------------------------------------------------------->
                <section id ="div-login">
                        ...
                        <form action="../vendor/correo/enviar.php" method="POST" id="form-correo">
                            <div class="row">
                                <div class="col-12">
                                        <input required name="form-correo" id="recuperar-correo" type="text" placeholder="Dirección de Correo"><br>
                                </div>
                            </div>
                            <button value="Submit form" id="button-1" type="submit">Enviar Correo</button>
                        </form>
                    </section> 
<!--Segundo Cuadro---------------------------------------------------------------------------------------------------------------------------------->
