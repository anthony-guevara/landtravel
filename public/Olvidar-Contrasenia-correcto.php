...
<!--Primer Cuadro---------------------------------------------------------------------------------------------------------------------------------->
        ...
        <h1>Recuperación de Contraseña</h1>
          <p style="font-size: 20px;">Datos enviados al correo correctamente!.</p s>
         <form>
 <div class="row">
          <div class="col-12">
    <button onclick="document.location.href = 'login.php'" id="button-confirmacion" type="button">Iniciar Sesión</button>
</div>
</div>
