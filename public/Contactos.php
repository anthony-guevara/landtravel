  ...
  <div class="row">
    ...
    <h1 style="text-align:center"> <span class="orangetittle">VALORES EMPRESARIALES</span> </h1>
                    <p style="color:black">La empresa promueve valores que le permiten mejorar la relación con el cliente,
                       ...
                       Entre los valores que la empresa practica están:<br>
                       <a>HONESTIDAD</a><br>
                       <a>RESPETO MUTUO</a><br>
                       <a>TRABAJO EN EQUIPO</a><br>
                       <a>RESPONSABILIDAD</a><br>
                       <a>PROFESIONALISMO</a><br>
                       <a>TRANSPARENCIA EN LAS ACCIONES</a><br>
                       <a>COMPROMISO</a><br>
                       <a>CRECIMIENTO</a><br>
    ...
    <div class="col">
                        ...
                        <a>PBX +504 2520-2324</a><br><br>
                    </div><br>
                    <div id="email">
                        <p id="email"><img style="width:30px" id="img_email" src="../img/email.png"> <span class="orangetittle">EMAIL</span> </p>
