            ...
            <div class="container" style="text-align:center">
              <div class="row">
                <div class="col col-sm-12">
                  <h1 class="colorletra" id="titulo" style="text-align: center; margin-top: 4px; margin-bottom:4rem; ">
                    Gestion Paises
                    ...
                    <form class="form-inline" style="justify-content: flex-end; margin-bottom: 0px;margin-top:50px;">
                      <button id="btpais" type="button" class=" btn btn-primary mb-2" onclick="nuevoPais()"
                        style="background-color: #e65b02; border-color: #e65b02;  width: 198px; margin-bottom:0px !important;"
                        data-toggle="modal" data-target="#modalnuevopais" id="agregarPais"><i
            ...
            <div class="modal" id="modalpais" tabindex="-1" role="dialog">
              <div class="modal-dialog modales" role="document">
                <div class="modal-content">
                  ...
                  <button type="button" class=" buttones" id="guardarpais" onclick="cerrar()">Guardar<i
                ...
                <div class="modal-body">
                  ...
                  <form id="informacionnuevopais">
                    <div class="row">
                      ...
                      <div class="col-6">
                        <input type="text" id="nombrenuevopais" placeholder="nombrepais"><br>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-12">
