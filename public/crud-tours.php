                  ...
                  <div class="col col-sm-12">
                    ...
                    <div class="container">
                      <form class="form-inline" style="justify-content: flex-end; margin-bottom: 0px;">
                        <button type="button" class="btn btn-primary mb-2" style="background-color: #e65b02; border-color: #e65b02; margin-right: 15px; width: 176px;" data-toggle="modal" data-target="#modalAdd">Agregar &nbsp; <i class="fas fa-plus"></i></button>
                      </form>
                    ...
                    <div class="tableText col col-lg-12 col-md-12 col-sm-12">
                      <table class="table table-striped bordeado" id="tb-tours"> 
